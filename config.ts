...
export const rpcUrl: string = 'https://mainnet.helius-rpc.com/?api-key='
export const rpcToken: string | undefined = undefined

export const wallet = Keypair.fromSecretKey(Uint8Array.from([4,129,159,124,191,54,,176,118]))    // Keypair here


export const connection = new Connection("https://mainnet.helius-rpc.com/?api-key=", "processed")
